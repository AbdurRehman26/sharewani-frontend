<template>
    <div class="screening-data-section">
        ...
        <div class="table-section table-min-width tablet-table-min-width ">
        ...
        <pagination
            totalRecords="Showing 1 to 10 of 57 records"
    ...
    methods: {
        initializeData() {
            ...
            let screeningFields = this.configurationData.screeningData
                .sectionReferenceTable.fields //get user data from store
