        ...
        <div class="filter-section row-min-space">
            <div class="row">
                <div class="col-md-8 filter-title-section">
                    <h2>Description 1 Status</h2>
                </div>
                <div class="col-md-4 text-right">
                    <div class="row">
                        <div class="col-md-9">
                            <base-search
                                placeholder="Search description 1"
                            ></base-search>
                        </div>
                        <div class="col-md-3">
                            <base-button
    ...
    methods: {
        initializeData() {
            ...
            let documentVerificationFields = this.configurationData
                .screeningData.descriptionStatusOne.fields //get user data from store
            ...
            let documentVerificationItems = this.configurationData.screeningData
                .descriptionStatusOne.items //get user data from store
