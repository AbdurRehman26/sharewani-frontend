<template>
    <div class="infoengine">
        ...
        <pagination totalRecords="Showing 1 to 10 of 47 records"></pagination>
        <modify-status-popup
            modalTitle="Modify Relationship Status"
            modalLabel="Father"
        ></modify-status-popup>
    </div>
</template>
